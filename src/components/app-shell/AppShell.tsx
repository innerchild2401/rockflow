...
export function AppShell({
  ...
  return (
    <div className="flex h-[100dvh] max-h-[100dvh] flex-col overflow-hidden bg-[var(--background)]">
      ...
      />
      <main className="flex min-h-0 flex-1 flex-col overflow-hidden pl-0 lg:pl-64">
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden px-4 py-2 sm:px-6 sm:py-6 lg:px-8">
          {children}
        </div>
      </main>
      {sidebarOpen && (
